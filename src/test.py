...
# checklist/tests/task_agnostic/prob_stats.py and pred_stats.py
...
# field is defined in the tempaltes; we can filter based on any field/column
...
# 5. OLD IMPLEMENTATIONS OF METRICS
# Old implementations of metrics also work:

# getting classification tests (old implementations)
tests = test_utils.get_all_classification_tests()
